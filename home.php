...
.discount{
     ...
     background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(https://dornsife.usc.edu/news/wp-content/uploads/sites/7/2023/04/story-3195-768x432.jpg);
        min-height: 70vh;
        background-position: center;
        background-size: cover;
 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container h-100 d-flex align-items-center justify-content-center w-100">
        <div class="text-center text-white w-100">
            <h3 class="display-4 mx-5" style="font-weight:600;">India's Ambulance Service</h3>
    ...
    <div class="container" style="text-align: center;margin-top: -50px;">
     ...
     <div class="section-container" style="margin-top:50px" >
      ...
      <div class="section-container">
         ...
         <div class="columns image" style="background-image:url('c:\Users\bhavi\Downloads\images.4.4.pnj.jpeg')" data-aos="fade-left" data-aos-duration="3000">
            &nbsp;
         </div>
      </div>
      <div class="section-container">
...
<section>
    ...
    <section class="discount" data-aos="fade-up" data-aos-duration="3000">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                           <h2>Reserved Now & Get <span style="font-weight: 500;font-size: 3.5rem;">50%off by using Health id card.</span>
                            </h2>
